 ...
 */
/**
 * حدود الحجم — مضبوطة لتتلاءم مع Vercel Hobby (function timeout = 10s).
 * حجم 25-50 ميغابايت قابل للتنزيل + رفع في 10 ثوانٍ بسعة شبكة معقولة.
 * (للإصدارات الأكبر يجب الترقية إلى Pro الذي يسمح بـ 60-300 ثانية).
 */
export const MAX_SIZE_BYTES = Object.freeze({
	document: 50 * 1024 * 1024, // 50 م.ب — يكفي لمعظم الكتب الإسلاميّة
	audio: 30 * 1024 * 1024, //   30 م.ب — تلاوة/درس متوسّط
	video: 40 * 1024 * 1024 //   40 م.ب — مقطع قصير
});
