...
export const MAX_SIZE_BYTES = Object.freeze({
	document: 500 * 1024 * 1024, //  500 ميغابايت (كتاب PDF كبير جدّاً)
	audio: 250 * 1024 * 1024, //  250 ميغابايت (تلاوة/درس طويل عالي الجودة)
	video: 800 * 1024 * 1024 //  800 ميغابايت (محاضرة فيديو طويلة 720p)
});
