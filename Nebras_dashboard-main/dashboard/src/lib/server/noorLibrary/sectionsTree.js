...
export function isBlacklistedSectionName(name) {
	...
	// أخطاء كتابية متوقّعة في عبارة "دروس بترخيصها"؛ نلتقطها حتى لو
	// تغيّر حرف أو التصقت الكلمة بلاحقة إضافية.
	return /^دروس\s+ب(?:تدكصهك|ترخيص(?:ها|ه)?|ترخيصه?ا?)\b/u.test(n);
}
