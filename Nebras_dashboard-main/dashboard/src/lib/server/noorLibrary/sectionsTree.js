...
/**
 * علامات أخطاء إملائية/لوحة مفاتيح لا يجوز أن تظهر للمصنّف. نعامل أيّ
 * قسم يحتويها كأنه في القائمة السوداء، ثم نحذف أبناءه أيضاً.
 */
export const TYPO_SECTION_NAME_MARKERS = Object.freeze([
	'بتدكصهك',
	'تدكصهك'
]);
