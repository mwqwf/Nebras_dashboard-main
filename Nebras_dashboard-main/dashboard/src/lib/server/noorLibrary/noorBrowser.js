 ...
 *
 * لا نرجع إلى Puppeteer العاديّ هنا: محرّك مكتبة نور يجب أن يعمل بـ stealth
 * حصراً حتى لا يلتفّ حول طلب التشغيل الآمن عبر متصفّح مكشوف.
 */
async function loadPuppeteer() {
	...
	try {
		...
		state.lastError =
			'Puppeteer stealth غير متاح. ثبّت puppeteer-extra و puppeteer-extra-plugin-stealth وشغّل NOOR_USE_PUPPETEER=true.';
		return null;
	}
}
