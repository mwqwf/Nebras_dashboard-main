 ...
 *       NOOR_REQUIRE_STEALTH=true|false — إلزام stealth-plugin (افتراضي true).
...
async function loadPuppeteer() {
	...
	try {
		...
		if (readBoolEnv('NOOR_REQUIRE_STEALTH', true)) {
			...
			state.lastError =
				'Stealth Mode مطلوب لمحرّك Noor، لكن puppeteer-extra أو puppeteer-extra-plugin-stealth غير متاح.';
			return null;
		}
