 ...
 *                                          حتى لا يعمل إلا في بيئة مجهّزة).
 ...
 * ويضمن أنّ Noor لا يعمل عبر Puppeteer عاديّ مكشوف بدون Stealth.
 */
async function loadPuppeteer() {
	...
	try {
		...
		state.lastError =
			'Stealth Mode غير متاح: يلزم puppeteer-extra و puppeteer-extra-plugin-stealth لتشغيل Noor عبر Chromium.';
		return null;
	}
}
