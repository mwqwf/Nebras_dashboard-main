 ...
 *
 * نُجرّب أوّلاً `puppeteer-extra`. الرجوع لـ `puppeteer` العاديّ متاح فقط
 * إذا عُطّل شرط stealth صراحةً عبر NOOR_REQUIRE_STEALTH=false.
 */
async function loadPuppeteer() {
	...
	try {
		...
		if (requireStealth) {
			...
			state.lastError =
				'puppeteer-extra أو stealth plugin غير مثبّت — NOOR_REQUIRE_STEALTH=true يمنع التشغيل بدون Stealth Mode.';
			return null;
		}
