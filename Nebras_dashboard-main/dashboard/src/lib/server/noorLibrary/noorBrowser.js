 ...
 *
 * لا نرجع إلى puppeteer العاديّ هنا: محرّك نور يجب أن يعمل في Stealth Mode
 * فقط حتى لا يضرب Cloudflare بمتصفّح مكشوف.
 */
async function loadPuppeteer() {
	...
	try {
		...
		state.lastError =
			'Stealth Mode غير متاح — ثبّت puppeteer-extra و puppeteer-extra-plugin-stealth قبل تشغيل محرّك نور.';
		return null;
	}
}
