 ...
 *       NOOR_REQUIRE_STEALTH=true|false — إلزام stealth-plugin عند تفعيل
 *                                          Puppeteer (افتراضي true).
 ...
 *
 * نُجرّب أوّلاً `puppeteer-extra` + stealth. الرجوع إلى `puppeteer` العاديّ
 * مسموح فقط إذا ضُبط NOOR_REQUIRE_STEALTH=false صراحةً.
 */
