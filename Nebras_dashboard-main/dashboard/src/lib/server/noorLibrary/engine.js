...
async function processBook({ url, bookId, sections }) {
	...
	if (!secondaryId) {
		throw Object.assign(new Error('فشل تحديد secondaryId بعد التصنيف — محرك نور يتطلب المسار الثلاثي كاملاً.'), {
	...
	if (!secondary) {
		throw Object.assign(new Error('secondary لم يُعثر عليه بعد التصنيف — لا يُسمح بمحتوى خارج المستوى الثالث.'), {
