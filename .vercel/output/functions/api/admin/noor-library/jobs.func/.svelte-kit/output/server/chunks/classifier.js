import { v as validateHierarchyPath } from "./sectionsTree2.js";
...
function tokenSetsOverlapRatio(setA, setB) {
  ...
  return inter / (/* @__PURE__ */ new Set([...setA, ...setB])).size;
}
...
async function classifyBookIntoHierarchy(sections, bookMeta) {
  ...
  const validation = sug ? validateHierarchyPath(
...
async function classifyAutonomous(sections, bookMeta) {
...
export {
  classifyBookIntoHierarchy as a,
  classifyAutonomous as c
};
